...
{
    public static function waterRequired()
    {
        return new static("No Water. Please fill the machine");
    }
}

class NoBeansException extends EspressoMachineException
{
    public static function beansRequired()
    {
        return new static("No Beans. Please fill the machine");
    }
}
...
{
    public static function alreadyFilled()
    {
        return new static('Container is already filled' );
    }

    public static function tooFull()
    {
        return new static('Added too much. Container is too full.' );
    }
}
